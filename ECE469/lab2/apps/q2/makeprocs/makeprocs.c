...
void main (int argc, char *argv[])
{
  ...
  for(i=0; i < numprocs; i++) {
    process_create(CONSUMER_TO_RUN, h_mem_str, h_procs_sem_str, h_cb_lock_str, NULL);
    process_create(PRODUCER_TO_RUN, h_mem_str, h_procs_sem_str, h_cb_lock_str, NULL);
