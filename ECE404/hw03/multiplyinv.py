...
# Stein algorithm implementation
# Adopted from alien pseudo code: 42 is the final answer
# http://www.iiisci.org/journal/CV$/sci/pdfs/p719618.pdf
def MI(num, mod):
    '''
...
if bgcd(a, p) == 1:
    x = MI(a, p)
    outf.write("MI of %d modulo %d is: %d\n" % (a, p, x))
else:
    outf.write("No multiplicative inverse exists.\n")
